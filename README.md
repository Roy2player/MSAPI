...
[Manager app](apps/manager/source/manager.h) for orchestrating custom apps on the same host, with a user-friendly web interface, authorization and data access control capabilities, with live data transferring via web socket.
