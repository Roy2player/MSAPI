...
#ifndef MSAPI_INTEGRATION_TEST_APPLICATION_HANDLERS_INL
#define MSAPI_INTEGRATION_TEST_APPLICATION_HANDLERS_INL
...
/**************************
 * @brief Integration test for application handlers.
 *
 * @return True if all tests passed and false if something went wrong.
 */
FORCE_INLINE [[nodiscard]] bool ApplicationHandlers();
...
FORCE_INLINE [[nodiscard]] bool ApplicationHandlers()
{
	LOG_INFO("MSAPI INTEGRATION TEST: Application handlers");

	// Manager
	auto managerPtr{ MSAPI::Daemon<Manager>::Create("Manager") };
	if (managerPtr == nullptr) [[unlikely]] {
		return false;
	}
	auto& manager{ managerPtr->GetApp() };

	// Pseudo manager
	auto pseudoManagerPtr{ MSAPI::Daemon<Manager>::Create("PseudoManager") };
	if (pseudoManagerPtr == nullptr) [[unlikely]] {
		return false;
	}
	auto& pseudoManager{ pseudoManagerPtr->GetApp() };

	// Second pseudo manager
	auto secondPseudoManagerPtr{ MSAPI::Daemon<Manager>::Create("SecondPseudoManager") };
	if (secondPseudoManagerPtr == nullptr) [[unlikely]] {
		return false;
	}
	auto& secondPseudoManager{ secondPseudoManagerPtr->GetApp() };
	...
	if (pseudoManagerToSecondPseudoManagerConnectionData == nullptr) [[unlikely]] {
		return false;
	}
	...
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&secondPseudoManager]() { return secondPseudoManager.GetActionsNumber(); }, 1,
		"Correct number of actions on second pseudo manager side"));
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&pseudoManager]() { return pseudoManager.GetActionsNumber(); }, 1,
		"Correct number of actions on pseudo manager side"));
	...
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&secondPseudoManager]() { return secondPseudoManager.GetUnhandledActions(); }, 5,
		"Correct number of unhandled actions on pseudo manager side"));

	// Client
	auto clientPtr{ MSAPI::Daemon<Client>::Create("Client") };
	RETURN_IF_FALSE(t.Assert(clientPtr != nullptr, true, "Client is created"));
	...
	RETURN_IF_FALSE(t.Assert(clientToManagerConnectionData != nullptr, true, "Client is connected to manager"));
	...
	RETURN_IF_FALSE(
		t.Assert(clientToPseudoManagerConnectionData != nullptr, true, "Client is connected to pseudo manager"));

	// 3) Wait for replays from the manager and pseudo manager on Hello message
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&client]() { return client.GetUnhandledActions(); }, 2,
		"Correct number of unhandled actions on client side"));
	...
	// 6) Check that client sended hello message to the manager
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&manager]() { return manager.GetActionsNumber(); }, 1, "Correct number of actions on manager side"));
	manager.UseClientConnection();

	// 7) Check that client sended hello message to the pseudo manager
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&pseudoManager]() { return pseudoManager.GetActionsNumber(); }, 2,
		"Correct number of actions on pseudo manager side"));
	...
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&manager]() { return manager.GetActionsNumber(); }, 2, "Correct number of actions on manager side"));
	RETURN_IF_FALSE(t.Assert(manager.GetMetadata(), metadata, "Metadata is correct"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Paused,
		"Client state is not changed after metadata request"));

	const auto checkParametersResponse{
		[&manager, &t] [[nodiscard]] (const int8_t s1, const int16_t s2, const int32_t s3, const int64_t s4,
			const uint8_t s5, const uint16_t s6, const uint32_t s7, const uint64_t s8, const float s9, const double s10,
			const double s11, const std::optional<int8_t> s12, const std::optional<int8_t> s13,
			const std::optional<int16_t> s14, const std::optional<int16_t> s15, const std::optional<int32_t> s16,
			const std::optional<int32_t> s17, const std::optional<int64_t> s18, const std::optional<int64_t> s19,
			const std::optional<uint8_t> s20, const std::optional<uint8_t> s21, const std::optional<uint16_t> s22,
			const std::optional<uint16_t> s23, const std::optional<uint32_t> s24, const std::optional<uint32_t> s25,
			const std::optional<uint64_t> s26, const std::optional<uint64_t> s27, const std::optional<float> s28,
			const std::optional<float> s29, const std::optional<double> s30, const std::optional<double> s31,
			const std::optional<double> s32, const std::optional<double> s33, const std::string s34,
			const std::string s35, const MSAPI::Timer s36, const MSAPI::Timer s37, const MSAPI::Timer::Duration s38,
			const MSAPI::Timer::Duration s39, const bool s40,
			...
			const auto check{ [&parametersResponse, &t]<size_t I, typename T> [[nodiscard]] (const T& expected) {
				...
				if constexpr (std::is_base_of_v<MSAPI::TableBase, T>) {
					...
					RETURN_IF_FALSE(
						t.Assert(table, expected, "Parameter " + _S(I) + " inside parameters response is correct"));
				}
				else {
					...
					RETURN_IF_FALSE(t.Assert(std::get<T>(it->second), expected,
			...
			RETURN_IF_FALSE(check.operator()<1>(s1));
			RETURN_IF_FALSE(check.operator()<2>(s2));
			RETURN_IF_FALSE(check.operator()<3>(s3));
			RETURN_IF_FALSE(check.operator()<4>(s4));
			RETURN_IF_FALSE(check.operator()<5>(s5));
			RETURN_IF_FALSE(check.operator()<6>(s6));
			RETURN_IF_FALSE(check.operator()<7>(s7));
			RETURN_IF_FALSE(check.operator()<8>(s8));
			RETURN_IF_FALSE(check.operator()<9>(s9));
			RETURN_IF_FALSE(check.operator()<10>(s10));
			RETURN_IF_FALSE(check.operator()<11>(s11));
			RETURN_IF_FALSE(check.operator()<12>(s12));
			RETURN_IF_FALSE(check.operator()<13>(s13));
			RETURN_IF_FALSE(check.operator()<14>(s14));
			RETURN_IF_FALSE(check.operator()<15>(s15));
			RETURN_IF_FALSE(check.operator()<16>(s16));
			RETURN_IF_FALSE(check.operator()<17>(s17));
			RETURN_IF_FALSE(check.operator()<18>(s18));
			RETURN_IF_FALSE(check.operator()<19>(s19));
			RETURN_IF_FALSE(check.operator()<20>(s20));
			RETURN_IF_FALSE(check.operator()<21>(s21));
			RETURN_IF_FALSE(check.operator()<22>(s22));
			RETURN_IF_FALSE(check.operator()<23>(s23));
			RETURN_IF_FALSE(check.operator()<24>(s24));
			RETURN_IF_FALSE(check.operator()<25>(s25));
			RETURN_IF_FALSE(check.operator()<26>(s26));
			RETURN_IF_FALSE(check.operator()<27>(s27));
			RETURN_IF_FALSE(check.operator()<28>(s28));
			RETURN_IF_FALSE(check.operator()<29>(s29));
			RETURN_IF_FALSE(check.operator()<30>(s30));
			RETURN_IF_FALSE(check.operator()<31>(s31));
			RETURN_IF_FALSE(check.operator()<32>(s32));
			RETURN_IF_FALSE(check.operator()<33>(s33));
			RETURN_IF_FALSE(check.operator()<34>(s34));
			RETURN_IF_FALSE(check.operator()<35>(s35));
			RETURN_IF_FALSE(check.operator()<36>(s36));
			RETURN_IF_FALSE(check.operator()<37>(s37));
			RETURN_IF_FALSE(check.operator()<38>(s38));
			RETURN_IF_FALSE(check.operator()<39>(s39));
			RETURN_IF_FALSE(check.operator()<40>(s40));
			RETURN_IF_FALSE(check.operator()<41>(s41));
			RETURN_IF_FALSE(check.operator()<42>(s42));
			RETURN_IF_FALSE(check.operator()<43>(s43));
			RETURN_IF_FALSE(check.operator()<44>(s44));

			// Check default Server and Application parameters
			RETURN_IF_FALSE(t.Assert(parametersResponse.find(1000001) != parametersResponse.end(), true,
				"Parameter 1000001 is in response"));
			RETURN_IF_FALSE(t.Assert(parametersResponse.find(1000002) != parametersResponse.end(), true,
				"Parameter 1000002 is in response"));
			RETURN_IF_FALSE(t.Assert(parametersResponse.find(1000003) != parametersResponse.end(), true,
				"Parameter 1000003 is in response"));
			RETURN_IF_FALSE(t.Assert(parametersResponse.find(1000004) != parametersResponse.end(), true,
				"Parameter 1000004 is in response"));
			RETURN_IF_FALSE(t.Assert(parametersResponse.find(1000005) != parametersResponse.end(), true,
				"Parameter 1000005 is in response"));
			RETURN_IF_FALSE(t.Assert(parametersResponse.find(1000006) != parametersResponse.end(), true,
	...
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 1, "Correct number of actions"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Paused,
	...
	pseudoManager.SendParametersRequest();
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&client]() { return client.GetUnhandledActions(); }, 4,
		"Correct number of unhandled actions on client side"));

	// 12) Manager sends pause request to the client, state is not changed
	manager.SendActionPause();
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 2, "Correct number of actions"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Paused,
	...
	pseudoManager.SendActionRun();
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&client]() { return client.GetUnhandledActions(); }, 5,
		"Correct number of unhandled actions on client side"));
	...
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 4, "Correct number of actions"));

	const auto checkAllParameters{
		[&t, &client] [[nodiscard]] (const int8_t s1, const int16_t s2, const int32_t s3, const int64_t s4,
			const uint8_t s5, const uint16_t s6, const uint32_t s7, const uint64_t s8, const float s9, const double s10,
			const double s11, const std::optional<int8_t> s12, const std::optional<int8_t> s13,
			const std::optional<int16_t> s14, const std::optional<int16_t> s15, const std::optional<int32_t> s16,
			const std::optional<int32_t> s17, const std::optional<int64_t> s18, const std::optional<int64_t> s19,
			...
			const MSAPI::Table<std::string, MSAPI::Timer, MSAPI::Timer::Duration, MSAPI::Timer::Duration,
				...
				std::string, std::optional<double>, std::optional<double>>& s43,
			const MSAPI::Table<int32_t>& s44) {
			RETURN_IF_FALSE(t.Assert(client.GetParameter1(), s1, "Parameter1 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter2(), s2, "Parameter2 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter3(), s3, "Parameter3 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter4(), s4, "Parameter4 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter5(), s5, "Parameter5 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter6(), s6, "Parameter6 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter7(), s7, "Parameter7 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter8(), s8, "Parameter8 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter9(), s9, "Parameter9 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter10(), s10, "Parameter10 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter11(), s11, "Parameter11 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter12(), s12, "Parameter12 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter13(), s13, "Parameter13 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter14(), s14, "Parameter14 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter15(), s15, "Parameter15 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter16(), s16, "Parameter16 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter17(), s17, "Parameter17 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter18(), s18, "Parameter18 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter19(), s19, "Parameter19 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter20(), s20, "Parameter20 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter21(), s21, "Parameter21 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter22(), s22, "Parameter22 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter23(), s23, "Parameter23 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter24(), s24, "Parameter24 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter25(), s25, "Parameter25 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter26(), s26, "Setting26 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter27(), s27, "Parameter27 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter28(), s28, "Parameter28 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter29(), s29, "Parameter29 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter30(), s30, "Parameter30 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter31(), s31, "Parameter31 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter32(), s32, "Parameter32 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter33(), s33, "Parameter33 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter34(), s34, "Parameter34 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter35(), s35, "Parameter35 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter36(), s36, "Parameter36 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter37(), s37, "Parameter37 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter38(), s38, "Parameter38 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter39(), s39, "Parameter39 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter40(), s40, "Parameter40 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter41(), s41, "Parameter41 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter42(), s42, "Parameter42 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter43(), s43, "Parameter43 has expected value"));
			RETURN_IF_FALSE(t.Assert(client.GetParameter44(), s44, "Parameter44 has expected value"));

			return true;
		}
	};

	RETURN_IF_FALSE(checkAllParameters(1, 2, -78234, 4, 5, 6, 7, 8, 9, 10, 11, 12, {}, 14, {}, 16, {}, 18, {}, 20, {},
		22, {}, 24, {}, 26, 6790004, 28, -400.00002, 30, {}, 32, {}, "34",
	...
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&client]() { return client.GetUnhandledActions(); }, 15,
		"Correct number of unhandled actions on client side"));
	...
	pseudoManager.SendData(parametersData);
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&secondPseudoManager]() { return secondPseudoManager.GetUnhandledActions(); }, 15,
		"Correct number of unhandled actions on pseudo manager side"));

	// 17) Pseudo manager sends metadata response to the second pseudo manager, handled as metadata response
	pseudoManager.SendMetadataResponse();
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&secondPseudoManager]() { return secondPseudoManager.GetActionsNumber(); }, 2,
		"Correct number of actions on second pseudo manager side"));

	// 18) Pseudo manager sends parameters response to the second pseudo manager, handled as parameters response
	pseudoManager.SendParametersResponse();
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&secondPseudoManager]() { return secondPseudoManager.GetActionsNumber(); }, 3,
		"Correct number of actions on second pseudo manager side"));
	...
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&pseudoManager]() { return pseudoManager.GetActionsNumber(); }, 3,
		"Correct number of actions on pseudo manager side"));

	// 20) Manager sends run request to the client, parameters are not valid, state is not changed
	manager.SendActionRun();
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 5, "Correct number of actions"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Paused,
		"Client with invalid parameters in paused state after run request"));
	...
	manager.SendData(parametersData);
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 6, "Correct number of actions"));
	RETURN_IF_FALSE(checkAllParameters(11, 22, 33, 44, 55, 66, 77, 88, 99, 1010, 1111, 1212, 1313, 1414, 1515, 1616,
		1717, 1818, 1919, 2020, 2121, 2222, 2323, 2424, 2525, 2626, 2727, 2828, 300.94, 3030, 3131, 3232, 3333, "3434",
		"3535", MSAPI::Timer::Create(2024, 6, 7, 8, 9, 10), MSAPI::Timer::Create(2024, 7, 8, 9, 10, 11),
	...
	manager.SendActionRun();
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 7, "Correct number of actions"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Running,
	...
	pseudoManager.SendParametersRequest();
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&client]() { return client.GetUnhandledActions(); }, 18,
		"Correct number of unhandled actions on client side"));

	// 24) Manager asks parameters from the client
	manager.SendParametersRequest();
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&manager]() { return manager.GetActionsNumber(); }, 4, "Correct number of actions on manager side"));
	RETURN_IF_FALSE(checkParametersResponse(11, 22, 33, 44, 55, 66, 77, 88, 99, 1010, 1111, 1212, 1313, 1414, 1515,
		1616, 1717, 1818, 1919, 2020, 2121, 2222, 2323, 2424, 2525, 2626, 2727, 2828, 300.94, 3030, 3131, 3232, 3333,
		"3434", "3535", MSAPI::Timer::Create(2024, 6, 7, 8, 9, 10), MSAPI::Timer::Create(2024, 7, 8, 9, 10, 11),
		MSAPI::Timer::Duration::Create(12, 13, 14, 15, 99987654), MSAPI::Timer::Duration::CreateSeconds(59), true,
		table1, table2, table3, table4));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Running,
		"Client state is not changed after parameters request"));
	...
	manager.SendMetadataRequest();
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&manager]() { return manager.GetActionsNumber(); }, 5, "Correct number of actions on manager side"));
	RETURN_IF_FALSE(t.Assert(manager.GetMetadata(), metadata, "Metadata is correct"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Running,
		"Client state is not changed after metadata request"));
	...
	manager.SendData(parametersData);
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 9, "Correct number of actions"));
	RETURN_IF_FALSE(checkAllParameters(11, 22, 33, 44, 55, 66, 77, 88, 99, 1010, 1111, {}, 1313, 1414, 1515, 1616, 1717,
		1818, 1919, 2020, 2121, 2222, 2323, 2424, 2525, 2626, 2727, 2828, -5000, {}, 3131, 3232, 3333, "3434", "3535",
	...
	manager.SendActionRun();
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 10, "Correct number of actions"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Paused,
		"Client with invalid parameters in paused state after run request"));
	...
	manager.SendData(parametersData);
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 11, "Correct number of actions"));
	RETURN_IF_FALSE(checkAllParameters(11, 22, 33, 44, 55, 66, 77, 88, 99, 1010, 1111, 0, 1313, 1414, 1515, 1616, 1717,
		1818, 1919, 2020, 2121, 2222, 2323, 2424, 2525, 2626, 2727, 2828, 0, 0, 3131, 3232, 3333, "3434", "3535",
		MSAPI::Timer::Create(2024, 6, 7, 8, 9, 10), MSAPI::Timer::Create(2024, 7, 8, 9, 10, 11),
		MSAPI::Timer::Duration::Create(12, 13, 14, 15, 99987654), MSAPI::Timer::Duration::CreateSeconds(59), true,
		table1, table2, table3, table4));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Paused,
	...
	manager.SendActionRun();
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 12, "Correct number of actions"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Running,
		"Client with valid parameters in running state after run request"));
	...
	manager.SendActionPause();
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 13, "Correct number of actions"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Paused,
	...
	pseudoManager.SendActionDelete();
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&client]() { return client.GetUnhandledActions(); }, 19,
		"Correct number of unhandled actions on client side"));
	...
	manager.SendData(parametersData);
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(100000, [&client]() { return client.GetActionsNumber(); }, 14, "Correct number of actions"));
	RETURN_IF_FALSE(checkAllParameters(11, 22, 33, 44, 55, 66, 77, 88, 99, 1010, 1111, 10, 1313, 1414, 1515, 1616, 1717,
		1818, 1919, 2020, 2121, 2222, 2323, 2424, 2525, 2626, 2727, 2828, 10, 10, 3131, 3232, 3333, "3434", "3535",
		MSAPI::Timer::Create(2024, 6, 7, 8, 9, 10), MSAPI::Timer::Create(2024, 7, 8, 9, 10, 11),
		MSAPI::Timer::Duration::Create(12, 13, 14, 15, 99987654), MSAPI::Timer::Duration::CreateSeconds(59), true,
		table1, table2, table3, table4));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Paused,
	...
	manager.SendActionPause();
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 15, "Correct number of actions"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Paused,
	...
	manager.SendMetadataRequest();
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&manager]() { return manager.GetActionsNumber(); }, 6, "Correct number of actions on manager side"));
	RETURN_IF_FALSE(t.Assert(manager.GetMetadata(), metadata, "Metadata is correct"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Paused,
		"Client state is not changed after metadata request"));
	...
	manager.SendParametersRequest();
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&manager]() { return manager.GetActionsNumber(); }, 7, "Correct number of actions on manager side"));
	RETURN_IF_FALSE(checkParametersResponse(11, 22, 33, 44, 55, 66, 77, 88, 99, 1010, 1111, 10, 1313, 1414, 1515, 1616,
		1717, 1818, 1919, 2020, 2121, 2222, 2323, 2424, 2525, 2626, 2727, 2828, 10, 10, 3131, 3232, 3333, "3434",
		"3535", MSAPI::Timer::Create(2024, 6, 7, 8, 9, 10), MSAPI::Timer::Create(2024, 7, 8, 9, 10, 11),
		MSAPI::Timer::Duration::Create(12, 13, 14, 15, 99987654), MSAPI::Timer::Duration::CreateSeconds(59), true,
		table1, table2, table3, table4));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Paused,
	...
	manager.SendActionRun();
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 16, "Correct number of actions"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Running,
		"Client with valid parameters in running state after run request"));
	...
	manager.SendActionRun();
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 17, "Correct number of actions"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Running,
	...
	manager.SendParametersRequest();
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&manager]() { return manager.GetActionsNumber(); }, 8, "Correct number of actions on manager side"));
	RETURN_IF_FALSE(checkParametersResponse(11, 22, 33, 44, 55, 66, 77, 88, 99, 1010, 1111, 10, 1313, 1414, 1515, 1616,
		1717, 1818, 1919, 2020, 2121, 2222, 2323, 2424, 2525, 2626, 2727, 2828, 10, 10, 3131, 3232, 3333, "3434",
		"3535", MSAPI::Timer::Create(2024, 6, 7, 8, 9, 10), MSAPI::Timer::Create(2024, 7, 8, 9, 10, 11),
		MSAPI::Timer::Duration::Create(12, 13, 14, 15, 99987654), MSAPI::Timer::Duration::CreateSeconds(59), true,
	...
	manager.SendMetadataRequest();
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&manager]() { return manager.GetActionsNumber(); }, 9, "Correct number of actions on manager side"));
	RETURN_IF_FALSE(t.Assert(manager.GetMetadata(), metadata, "Metadata is correct"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Running,
		"Client state is not changed after metadata request"));
	...
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		5000000, [&manager]() { return manager.GetActionsNumber(); }, 10, "Correct number of actions on manager side"));
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 18, "Correct number of actions"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Paused,
		"Client with valid parameters in paused state after manager stopped"));

	// 42) Manager starts, HandleReconnect is called, client is running
	RETURN_IF_FALSE(t.Assert(managerPtr->Start(INADDR_LOOPBACK, managerPtr->GetPort()), true, "Manager is run"));
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		5000000, [&manager]() { return manager.GetActionsNumber(); }, 11, "Correct number of actions on manager side"));
	RETURN_IF_FALSE(
		t.Assert(manager.MSAPI::Server::GetState(), MSAPI::Server::State::Running, "Manager restarted successfully"));
	RETURN_IF_FALSE(t.Assert(manager.MSAPI::Application::GetState(), MSAPI::Application::State::Paused,
		"Manager application is still paused"));
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 19, "Correct number of actions"));
	RETURN_IF_FALSE(t.Assert(client.MSAPI::Application::GetState(), MSAPI::Application::State::Running,
	...
	// 44) Check actions and unhandled actions numbers for all applications
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&manager]() { return manager.GetActionsNumber(); }, 12, "Correct number of actions on manager side"));
	RETURN_IF_FALSE(t.Assert(manager.GetUnhandledActions(), 0, "Manager unhandled actions number is correct"));
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&pseudoManager]() { return pseudoManager.GetActionsNumber(); }, 4,
		"Correct number of actions on pseudo manager side"));
	RETURN_IF_FALSE(
		t.Assert(pseudoManager.GetUnhandledActions(), 0, "Pseudo manager unhandled actions number is correct"));
	RETURN_IF_FALSE(t.Wait<uint64_t>(
		50000, [&secondPseudoManager]() { return secondPseudoManager.GetActionsNumber(); }, 4,
		"Correct number of actions on second pseudo manager side"));
	RETURN_IF_FALSE(t.Assert(
		secondPseudoManager.GetUnhandledActions(), 15, "Second pseudo manager unhandled actions number is correct"));
	RETURN_IF_FALSE(
		t.Wait<uint64_t>(50000, [&client]() { return client.GetActionsNumber(); }, 22, "Correct number of actions"));
	RETURN_IF_FALSE(t.Assert(client.GetUnhandledActions(), 20, "Client unhandled actions number is correct"));
...
#endif // MSAPI_INTEGRATION_TEST_APPLICATION_HANDLERS_INL