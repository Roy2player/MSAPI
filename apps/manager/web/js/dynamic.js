...
/**
 * @brief Add clicking to data-form-item='button' by pressing enter in any data-form-item='input' inside provided node.
 */
function InitForm(node)
{
	...
	let button = node.querySelectorAll("[data-form-item='button']");
	if (!button) {
...
/**
 * @brief Add data-trigger-[toggle|remove|add]='id1,id2' action to each mentioned id and invoke with "active" class to
 * each data-trigger-id='id' inside provided node.
 */
