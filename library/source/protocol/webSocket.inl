...
private:
	...
	friend class MSAPI::Test::Protocol::WebSocket::Observer;
};
...
public:
	...
	struct FragmentedData {
		...
		FORCE_INLINE FragmentedData(FragmentedData&&) = default;
		FragmentedData(const FragmentedData&) = delete;
		FragmentedData& operator=(const FragmentedData&) = delete;
		FragmentedData& operator=(FragmentedData&&) = delete;
	};
